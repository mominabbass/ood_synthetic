...
Our synthetic data can be found in the data/data_ethical directory. We’ve also made it available on [HuggingFace](https://huggingface.co/datasets/abbasm2/synthetic_ood) ![Hugging Face Logo](https://huggingface.co/front/assets/huggingface_logo.svg). 
